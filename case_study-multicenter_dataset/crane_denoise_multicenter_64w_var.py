...
file_list = file_list.loc[file_list.File_List.str.contains('64var')]
file_list = file_list.File_List.to_list()

irt_srl_path = 'srl/Navarro_openSwathIrt_64w_var.tsv'
srl_path = 'srl/Navarro_openSwathDecoySrlTsv_64w_var.tsv'
